...
- 브랜치: develop
- 마지막 루프: 2026-04-10 — P9 전체 완료
- 최근 주요 변경:
  - voice/record.tsx: 녹음 실시간 metering → 20바 오디오 레벨 시각화
  - friend.ts, gift.ts: 전체 목록 API에 limit/offset 페이지네이션 + total count 추가
  - VoicesPage.tsx: 음성 테스트 재생 기능 (TTS 생성 → 즉시 재생)
